...
struct ThemeRegionsScrubbing { // Max dep:0
	char back[4]; // type_index: 0
	char text[4]; // type_index: 0
...
struct NodeGeometrySubdivisionSurface { // Max dep:1
	uchar uv_smooth; // type_index: 1
	uchar boundary_smooth; // type_index: 1
}; 

struct NodeGeometryMeshCircle { // Max dep:1
	uchar fill_type; // type_index: 1
}; 

struct NodeGeometryMeshCylinder { // Max dep:1
	uchar fill_type; // type_index: 1
}; 

struct NodeGeometryMeshCone { // Max dep:1
	uchar fill_type; // type_index: 1
}; 
...
struct NodeGeometryUVUnwrap { // Max dep:1
...
struct MovieClipProxy { // Max dep:2
...
struct NodeScaleData { // Max dep:2
	short interpolation; // type_index: 2
	char extension_x; // type_index: 0
	char extension_y; // type_index: 0
}; 

struct NodeCornerPinData { // Max dep:2
	short interpolation; // type_index: 2
	char extension_x; // type_index: 0
	char extension_y; // type_index: 0
}; 

struct NodeDisplaceData { // Max dep:2
	short interpolation; // type_index: 2
	char extension_x; // type_index: 0
	char extension_y; // type_index: 0
}; 
...
struct NodeForeachGeometryElementInputItem { // Max dep:4
	char *name; // type_index: 0
	short socket_type; // type_index: 2
	char _pad[2]; // type_index: 0
	int identifier; // type_index: 4
...
struct NodeGeometryForeachGeometryElementInput { // Max dep:4
...
struct NodeRepeatItem { // Max dep:4
	char *name; // type_index: 0
	short socket_type; // type_index: 2
	char _pad[2]; // type_index: 0
	int identifier; // type_index: 4
...
struct NodeImageLayer { // Max dep:4
...
struct AssetLibraryReference { // Max dep:4
...
struct ImagePaintSettings { // Max dep:825
	Paint paint; // type_index: 825
	short flag; // type_index: 2
...
struct GP_Sculpt_Settings { // Max dep:839
	void *paintcursor; // type_index: 11
	int flag; // type_index: 4
...
struct XrSessionSettings { // Max dep:850
...
struct SceneDisplay { // Max dep:850
...
struct WaveShaderFxData { // Max dep:937
	ShaderFxData shaderfx; // type_index: 936
	float amplitude; // type_index: 7
	float period; // type_index: 7
	float phase; // type_index: 7
...
struct FileAssetSelectParams { // Max dep:962
...
struct ThemeRegions { // Max dep:1008
...
struct GroupNodeViewerPathElem { // Max dep:1066
	ViewerPathElem base; // type_index: 1066
	int node_id; // type_index: 4
	char _pad1[4]; // type_index: 0
}; 

struct SimulationZoneViewerPathElem { // Max dep:1066
	ViewerPathElem base; // type_index: 1066
